...
if (isset($_POST['update_teacher'])) {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['name'] != '') {
        ...
        if (!$upload) {
            ...
            if ($current_photo != '' && file_exists("../images/teachers/" . $current_photo)) {
...
if (isset($_GET['delete_id'])) {
    ...
    if ($photo_name != '' && file_exists("../images/teachers/" . $photo_name)) {
        unlink("../images/teachers/" . $photo_name);
    }

    $sql = "DELETE FROM teachers WHERE teach_id=$teach_id";
    if (mysqli_query($conn, $sql)) {
        $_SESSION['delete_teacher'] = "<div class='alert alert-success'>Teacher Deleted Successfully.</div>";
    } else {
        $_SESSION['delete_teacher'] = "<div class='alert alert-danger'>Failed to Delete Teacher.</div>";
    }
    header('location:' . SITEURL . 'admin/teachers.php');
    exit();
}
                        ...
                        <div class="table-responsive">
                            <table class="table bg-white rounded shadow-sm table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM teachers WHERE role = 'teacher' ORDER BY full_name";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?php echo SITEURL; ?>admin/teachers.php?delete_id=<?php echo $teach_id; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this teacher?');">
